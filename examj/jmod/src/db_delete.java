            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (more == JOptionPane.YES_OPTION) {
                    try {
                        ...
                        int b_check = myStatement.executeUpdate("DELETE FROM user WHERE User='examj_user'");
                        int c_check = myStatement.executeUpdate("FLUSH PRIVILEGES;");
                        int d_check = myStatement.executeUpdate("DROP DATABASE examj;");
