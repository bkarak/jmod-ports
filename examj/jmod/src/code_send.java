            ...
            public void actionPerformed(ActionEvent e) {
                ...
                || examj_gui.txt_file.getText().length() < 1) {
                    ...
                    try {
						...
						InsertCodeQuery icq = new InsertCodeQuery(date, time, name, surname, id, group, prj_name, lang, str_code, examiner, examj_gui.uuid_code);
						myStatement = icq.getStatement(connection);
                        int check_insert = myStatement.executeUpdate();
                        if (check_insert == 1) {
                            JOptionPane.showMessageDialog(win_upload,
