    ...
    public int user_exists() {
        ...
        if (action < 0) {
            ...
            try {
                ...
                String query_5 = "select count(*) from examj.users where username = '"
                                 + (String) cb_user.getSelectedItem()
                                 + "' and password = md5('" + ex_pass + "')";
                ResultSet rs5 = stmt.executeQuery(query_5);
                rs5.next();
    ...
    public void load_code() {
        ...
        btn_connect.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    String query_0 = "select username from examj.users";
                    ResultSet rs0 = stmt.executeQuery(query_0);
                    while (rs0.next()) {
        ...
        cb_user.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    Statement stmt = connection.createStatement();
                    String query_1 = "select distinct date from examj.code_uploaded where examiner='"
                                     + (String) cb_user.getSelectedItem() + "'";
        ...
        cb_date.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    Statement stmt = connection.createStatement();
                    String query_2 = "select distinct id from examj.code_uploaded where date = '"
                                     + (String) cb_date.getSelectedItem()
                                     + "'"
                                     + " and examiner ='"
                                     + (String) cb_user.getSelectedItem() + "'";
        ...
        cb_id.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    Statement stmt = connection.createStatement();
                    String query_3 = "select prj_name from examj.code_uploaded where date = '"
                                     + (String) cb_date.getSelectedItem()
                                     + "' and id ='"
                                     ...
                                     + " and examiner ='"
                                     + (String) cb_user.getSelectedItem() + "'";
                    ResultSet rs3 = stmt.executeQuery(query_3);
        ...
        btn_load_code.addActionListener(new ActionListener() {
            ...
            public void loadco() {
                ...
                if (rowCount == 1) {
                    ...
                    String query_4 = "select lang, code from examj.code_uploaded where date = '"
                                     + (String) cb_date.getSelectedItem()
                                     + "' and id ='"
                                     + (String) cb_id.getSelectedItem()
                                     + "' and prj_name ='"
                    ...
                    try {
                        Statement stmt = connection.createStatement();
                        ResultSet rs4 = stmt.executeQuery(query_4);
                        ...
                        examj_gui.txt_file.setText((String) cb_project
                                                   .getSelectedItem());
                        stmt.close();
                        rs4.close();
                        connection.close();
                ...
                if (rowCount == 1) {
                    ...
                    if (delete_project.length()>0) {
                        if (delete_project == possibilities.get(0)) {
                            delete_code = "DELETE from examj.code_uploaded where date = '"
                                          + (String) cb_date.getSelectedItem()
                                          + "' and id ='"
                                          + (String) cb_id.getSelectedItem()
                                          + "' and prj_name ='"
                        ...
                        try {
                            ...
                            int rm_check = myStatement
                                           .executeUpdate(delete_code);
                            if (rm_check > 0) {
                                JOptionPane.showMessageDialog(win_db_load_code,
