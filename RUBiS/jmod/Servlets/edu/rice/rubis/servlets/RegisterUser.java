 ...
 */
    ...
    throws IOException, ServletException
  {
    ...
    else
    {
      ...
      {
        conn = getConnection();
		GetRegionsQuery grq = new GetRegionsQuery(region);
        stmt = grq.getStatement(conn);
    ...
    try
    {
	  GetUsersNickname gun = new GetUsersNickname(nickname);
      stmt = gun.getStatement(conn);
      ResultSet rs = stmt.executeQuery();
      if (rs.first())
      {
    ...
    try
    {
	  ...
	  InsertUserQuery iuq = new InsertUserQuery(firstname,
												lastname,
												nickname,
												password,
												email,
    ...
    try
    {
	  GetUsersNickname2 gun2 = new GetUsersNickname2(nickname);
      stmt = gun2.getStatement(conn);
