 ...
 */
    ...
    throws IOException, ServletException
  {
    ...
    try
    {
      ...
      try
      {
		GetUsersID guid = new GetUsersID(sellerId);
        sellerStmt = guid.getStatement(conn);
      ...
      try
      {
		MaxBidQuery mbq = new MaxBidQuery(itemId.intValue());
        maxBidStmt = mbq.getStatement(conn);
      ...
      try
      {
		CountBidQuery cbq = new CountBidQuery(itemId.intValue());
        nbStmt = cbq.getStatement(conn);
